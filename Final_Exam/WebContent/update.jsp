...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="updateAction.jsp?debateID=<%= debateID %>">
				<table class="table table-striped"
					style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2"
								style="background-color: #eeeeee; text-align: center;">게시판 글 수정</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input type="text" class="form-control"
								placeholder="글 제목" name="debateTitle" maxlength="50" value="<%= debate.getDebateTitle() %>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용"
									name="debateContent" maxlength="2048" style="height: 350px;" value="<%= debate.getDebateContent() %>"></textarea></td>
						</tr>
					</tbody>
				</table>
